...
class RegisterCompanyStocks extends Component {
    constructor(props){
        super(props)
    ...
    registerCompany = (r) => {
        ...
        let company = {companyCode: this.state.companyCode, companyName: this.state.companyName, companyCEO: this.state.companyCEO,
            ...
            console.log('Registered Company =>' +JSON.stringify(company));

            CompaniesStoksService.registerCompanyStock(company).then(res =>{
                    ...
                    <div className='row'>
                        ...
                        <div className='card-body'>
                            <form>
                                ...
                                <button className='btn btn-success' onClick={this.registerCompany}>Register</button>
...
export default RegisterCompanyStocks;